...
public class AnnotatorDumperOLD extends Parallelizable {
	...
	private static AnnotationService annotator = null;
	
	
	
	private SAXBuilder builder = new SAXBuilder();
	/*
	 * 1. read doc from db and parse the XML
	 * 2. for each node:
	 * 	2.1. get dispName --> annotate dispName --> add new attributes to this node
	 * 	2.2. get mention  --> annotate mention  --> add new attributes to this mention
	 * 3. write new doc to file with name patter: [lang-project-id]
	 * if exception, write docID to failedDocsFileName
	 * 
	 */
	
	/* 
	 * node and mentions: example
	 * 
<node type="word" displayName="freeware" id="W5">
	<mentions>
		<mention sentenceId="1" id="W5.1" words="freeware">
			<mention_token id="1.5"/>
		</mention>
		<mention sentenceId="2" id="W5.2" words="free soft">
			<mention_token id="2.3"/>
		</mention>
	</mentions>
0
,
	<descriptions>
		<description URI="06567865-n" displayName="free_software" knowledgeBase="WordNet-3.0"/>
		<description URI="&%ComputerProgram+" knowledgeBase="SUMO"/>
	</descriptions>
</node>
